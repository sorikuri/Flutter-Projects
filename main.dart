    ...
    try {
      ...
      if (configDoc.exists) {
        ...
        if (allowedBssids.isNotEmpty && !allowedBssids.contains(bssid)) {
          setState(() {
            _statusMessage = 'Access Blocked: Not connected to authorized office Wi-Fi.';
            _isLoading = false;
          });
          return;
        }
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => QRScannerScreen(currentBssid: bssid!, currentDeviceId: deviceId),
        ),
      );
    } catch (e) {
      setState(() {
                ...
                children: [
                  ...
                  _isLoading
                      ...
                      : ElevatedButton.icon(
                          ...
                          icon: const Icon(Icons.qr_code_scanner, color: maroon),
                          label: const Text(
